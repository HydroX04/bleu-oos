...
const Report = () => {
  ...
  useEffect(() => {
    const loadStoredHash = async () => {
      ...
      try {
        const resp = await fetch('https://blockchain-service-5l6b.onrender.com/blockchain/report-hash', {
          method: 'POST',
  ...
  const secureReportOnBlockchain = async () => {
      ...
      try {
          ...
          const response = await fetch('https://blockchain-service-5l6b.onrender.com/blockchain/mint-report', {
              method: 'POST',
              headers: {
          ...
          if (result.success && result.transactionHash) {
              ...
              try {
                await fetch('https://blockchain-service-5l6b.onrender.com/blockchain/report-hash', {
                  method: 'POST',
                  headers: { 'Content-Type': 'application/json' },
                  body: JSON.stringify({ startDate: modalData.startDate, endDate: modalData.endDate })
                });
