...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (!authToken) { return; }
    fetch("https://ordering-service-8e9d.onrender.com/cart/admin/orders/total", { headers: { Authorization: `Bearer ${authToken}`, }, })
  ...
  useEffect(() => {
    if (!authToken) { return; }
    fetch("https://ordering-service-8e9d.onrender.com/cart/admin/orders/pending", { headers: { Authorization: `Bearer ${authToken}`, }, })
      .then((res) => { if (!res.ok) { throw new Error(`HTTP error! status: ${res.status}`); } return res.json(); })
      .then((orders) => {
  ...
  useEffect(() => {
    if (!authToken) { return; }
    fetch("https://ordering-service-8e9d.onrender.com/cart/admin/orders/today_count", { headers: { Authorization: `Bearer ${authToken}`, }, })
      .then((res) => { if (!res.ok) { throw new Error(`HTTP error! status: ${res.status}`); } return res.json(); })
      .then((data) => {
  ...
  useEffect(() => {
    if (!authToken) { return; }
    fetch("https://ordering-service-8e9d.onrender.com/cart/admin/orders/manage", { headers: { Authorization: `Bearer ${authToken}`, }, })
      .then((res) => { if (!res.ok) { throw new Error(`HTTP error! status: ${res.status}`); } return res.json(); })
      .then((data) => {
  ...
  useEffect(() => {
    if (!authToken) { return; }
    // Fetch all riders
    fetch("https://delivery-service-6zhu.onrender.com/delivery/riders", { headers: { Authorization: `Bearer ${authToken}`, }, })
      .then((res) => { if (!res.ok) { throw new Error(`HTTP error! status: ${res.status}`); } return res.json(); })
      .then((riders) => {
  ...
  useEffect(() => {
    ...
    fetch("https://ordering-service-8e9d.onrender.com/delivery/admin/delivery/orders", { headers: { Authorization: `Bearer ${authToken}`, }, })
      .then((res) => { if (!res.ok) { throw new Error(`HTTP error! status: ${res.status}`); } return res.json(); })
      .then((data) => {
  ...
  useEffect(() => {
    ...
    const fetchEarnings = async () => {
      ...
      try {
        const response = await fetch(`https://ordering-service-8e9d.onrender.com/delivery/admin/rider-earnings/aggregated/${earningsFilter}`, {
